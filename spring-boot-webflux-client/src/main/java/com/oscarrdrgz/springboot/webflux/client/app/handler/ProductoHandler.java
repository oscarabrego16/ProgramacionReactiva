package com.oscarrdrgz.springboot.webflux.client.app.handler;
...
import com.oscarrdrgz.springboot.webflux.client.app.models.Producto;
import com.oscarrdrgz.springboot.webflux.client.app.services.ProductoService;
...
public class ProductoHandler {
	...
	public Mono<ServerResponse> crear(ServerRequest request){
		 ...
		 ServerResponse.created(URI.create("/api/client/"+ p.getId()))
		 .contentType(APPLICATION_JSON)
		 .bodyValue(p)
