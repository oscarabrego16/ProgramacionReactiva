...
import com.oscarrdrgz.springboot.webflux.app.handler.ProductoHandler;

import static org.springframework.web.reactive.function.server.RouterFunctions.route;
import static org.springframework.web.reactive.function.server.RequestPredicates.*;

/*
Esta forma es más liviana y tiene procesos más ligeros para trabajar con WebFlux y
de forma reactiva que con un RestController, siendo programación 100% funcional.
*/
@Configuration
